...
@Component({
  ...
  .base-dialog {
    ...
    max-height:92vh;
    overflow:auto;
    border:1px solid color-mix(in srgb,var(--line,#d9e3ea) 75%,transparent);
    border-radius:34px;
    background:linear-gradient(145deg,var(--surface,#fff),var(--surface-soft,#f8fbff));
    box-shadow:0 24px 70px rgba(93,64,32,.16);
    padding:28px;
    color:var(--text,#13202b)
  }
  .base-dialog.wide {
    width:min(760px,100%)
  }
  .base-dialog::before {
    ...
    inset:0 0 auto;
    height:112px;
    border-radius:34px 34px 46% 46%;
    background:radial-gradient(circle at 18% 0,color-mix(in srgb,var(--brand,#a8793f) 22%,transparent),transparent 58%);
    pointer-events:none
  }
  .dialog-close {
    position:absolute;
    ...
    border:0;
    border-radius:16px;
    background:color-mix(in srgb,var(--surface-muted,#efe2d0) 86%,transparent);
  ...
  .solid {
    ...
    color:#1b1712;
    box-shadow:0 14px 34px color-mix(in srgb,var(--brand,#a8793f) 24%,transparent)
  }
