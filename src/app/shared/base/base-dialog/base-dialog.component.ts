  ...
  styles: [
    `
      ...
      .base-dialog {
        ...
        overflow: auto;
        border: 1px solid
          color-mix(in srgb, var(--line, #d9e3ea) 75%, transparent);
        border-radius: 34px;
        ...
        box-shadow: 0 24px 70px rgba(93, 64, 32, 0.16);
        padding: 28px;
      ...
      .base-dialog::before {
        ...
        background: radial-gradient(
          circle at 18% 0,
          color-mix(in srgb, var(--brand, #a8793f) 22%, transparent),
          transparent 58%
        );
        pointer-events: none;
      }
