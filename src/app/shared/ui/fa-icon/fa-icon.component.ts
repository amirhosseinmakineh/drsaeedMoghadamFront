...
const iconPaths: Record<string, string> = {
  ...
  settings:
    "M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm8.5 4a8.7 8.7 0 0 0-.1-1.2l2-1.5-2-3.5-2.5 1a9 9 0 0 0-2-1.2L15.5 3h-4l-.4 2.6a9 9 0 0 0-2 1.2l-2.5-1-2 3.5 2 1.5a8.7 8.7 0 0 0 0 2.4l-2 1.5 2 3.5 2.5-1a9 9 0 0 0 2 1.2l.4 2.6h4l.4-2.6a9 9 0 0 0 2-1.2l2.5 1 2-3.5-2-1.5c.1-.4.1-.8.1-1.2z",
  wallet:
