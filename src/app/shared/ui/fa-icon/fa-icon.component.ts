...
const iconPaths: Record<string, string> = {
  tooth: 'M12 2c-2.8 0-4 2.4-4 5.1 0 1.2.4 2.8.9 4.6.6 2.3 1 4.7 1.2 6.8.2 1.8 2.4 1.8 2.6 0 .2-.7 1.2-2.3 1.2-2.6 0-.3 0-.8-.1-1.3-.2-.7-.2-1.6-1.1-1.6-1.1 0-.9.5-1.4 1.1-1.6.5-.1 1-.2 1.3-.2 1.8 0 2.6.9 2.6 1.2 0 .2 1.4 0 2.4-1.8 2.7-5.1.2-2.1.6-4.5 1.2-6.8.5-1.8.9-3.4.9-4.6C20 4.4 18.8 2 16 2c-1.4 0-2.3.6-3 1.1C12.3 2.6 11.4 2 10 2h2z',
  home: 'M3 10.5 12 3l9 7.5v10a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1v-10z',
  doctor: 'M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm-7 9c.7-4 3.4-6 7-6s6.3 2 7 6H5zm7-5v4m-2-2h4',
  user: 'M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm-7 9c.7-4 3.4-6 7-6s6.3 2 7 6H5z',
  mobile: 'M8 2h8a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zm2 3h4M11 19h2',
  calendar: 'M5 4h14a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm0 5h14M8 2v4m8-4v4m-8 8 2 2 5-5',
  search: 'M10.5 18a7.5 7.5 0 1 1 5.3-2.2L21 21l-1.8 1.8-5.2-5.2A7.4 7.4 0 0 1 10.5 18z',
  ...
  users: 'M9 11a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zm6 10H3c.5-4 2.8-6 6-6s5.5 2 6 6zm2-9a3 3 0 1 0 0-6m4 15c-.3-2.6-1.6-4.3-3.8-5',
  ...
  heart: 'M12 21S4 16.5 4 9.5A4.5 4.5 0 0 1 12 6a4.5 4.5 0 0 1 8 3.5C20 16.5 12 21 12 21z',
  leaf: 'M20 4c-8 0-14 5-14 12 0 2.2 1.2 4 3.2 4C16 20 20 12 20 4zm-9 10c-2 1-3.5 2.5-5 5',
  phone: 'M6.5 3 10 6.5 8 9c1.2 2.3 2.7 3.8 5 5l2.5-2 3.5 3.5-2 4c-.3.6-1 .9-1.7.7C8.5 18.2 4.8 14.5 2.8 7.7 2.6 7 2.9 6.3 3.5 6l3-3z',
  ...
  brush: 'M4 20c2 0 3-.8 3-3l9-9-3-3-9 9c-2.2 0-3 1-3 3 0 1.7 1.3 3 3 3zm11-17 2-2 3 3-2 2',
  ...
  sparkle: 'M12 2l1.8 6.2L20 10l-6.2 1.8L12 18l-1.8-6.2L4 10l6.2-1.8L12 2zm6 13 1 3 3 1-3 1-1 3-1-3-3-1 3-1 1-3z',
  gallery: 'M4 5h16v14H4V5zm3 10 3-3 2 2 3-4 3 5',
  smile: 'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20zM8 9h.01M16 9h.01M8 14c1 2 2.4 3 4 3s3-1 4-3'
};
