...
export interface PatientCheque { id: number; patientFinancialCaseId: number; patientId: PatientGuid; patientName: string; patientFileNumber?: string | number | null; amount: number; sayadNumber: string; ownerName: string; dueDate: string; status: CommitmentStatus; }
export interface PatientPromissoryNote { id: number; patientFinancialCaseId: number; patientId: PatientGuid; patientName: string; patientFileNumber?: string | number | null; serialNumber: string; amount: number; dueDate: string; status: CommitmentStatus; }
export interface PatientDebt { id: number; patientId: PatientGuid; patientName: string; patientFileNumber?: string | number | null; patientPhoneNumber: string | null; patientFinancialCaseId: number; serviceName: string; amount: number; sourceType: FinancialSourceType; sourceId: number; dueDate: string; status: DebtStatus; }
export interface PatientFinancialTransaction { id: number; patientFinancialCaseId: number; patientId: PatientGuid; patientName?: string; patientFileNumber?: string | number | null; amount: number; type: 1; sourceType: FinancialSourceType; sourceId: number; createdAt: string; }
export interface PatientFinancialCommitment { id: number; type: FinancialSourceType; patientFinancialCaseId: number; patientId: PatientGuid; patientName: string; patientFileNumber?: string | number | null; amount: number; dueDate: string; status: CommitmentStatus; }
