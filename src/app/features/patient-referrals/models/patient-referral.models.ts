...
export const REFERRAL_STATUS_LABELS: Record<PatientReferralStatus, string> = {
  ...
  [PatientReferralStatus.ReservedPendingAdminApproval]: "رزرو شد؛ در انتظار تأیید حضور و ادمین",
...
export interface ReferralQuery { search?: string; status?: PatientReferralStatus | null; fromDate?: string; toDate?: string; page: number; pageSize: number }
