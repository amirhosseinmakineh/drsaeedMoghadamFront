...
@Component({
  ...
  `,
  styles: [`
    .detail-hero{display:grid;grid-template-columns:minmax(0,1fr) minmax(330px,.82fr);gap:36px;align-items:center;min-height:690px;padding-top:136px}.detail-hero h1{margin:10px 0 8px;font-size:clamp(2.6rem,6vw,5.4rem)}.detail-hero h2{margin:0 0 14px;color:var(--brand);font-size:clamp(1.3rem,2.4vw,2rem)}.hero-actions{display:flex;flex-wrap:wrap;gap:12px;margin-top:24px}.detail-media{position:relative}.detail-media img{width:100%;height:470px;object-fit:cover;border-radius:46px;box-shadow:var(--shadow);animation:mediaFloat 6s ease-in-out infinite alternate}.detail-media::before{content:'';position:absolute;inset:-18px;border:2px dashed color-mix(in srgb,var(--accent) 48%,transparent);border-radius:54px;transform:rotate(3deg);z-index:-1}.media-badge{position:absolute;inset:auto 22px 22px auto;display:inline-flex;align-items:center;gap:8px;padding:12px 15px;border-radius:999px;background:color-mix(in srgb,var(--surface) 82%,transparent);box-shadow:0 16px 40px rgba(0,0,0,.14);font-weight:950;color:var(--text);backdrop-filter:blur(16px)}.intro-panel{padding:42px;border:1px solid var(--line);border-radius:42px;background:color-mix(in srgb,var(--surface) 76%,transparent);box-shadow:var(--shadow)}.long-text{max-width:none;font-size:1.08rem}.three{grid-template-columns:repeat(3,minmax(0,1fr))}.two-column,.care-panel,.before-after{display:grid;grid-template-columns:minmax(0,1fr) minmax(310px,.9fr);gap:26px;align-items:center}.check-list{display:grid;gap:12px;margin:0;padding:0;list-style:none}.check-list li{display:flex;align-items:flex-start;gap:10px;padding:14px 16px;border:1px solid var(--line);border-radius:20px;background:color-mix(in srgb,var(--surface) 72%,transparent);font-weight:800}.check-list app-fa-icon{color:var(--brand);margin-top:5px}.timeline{display:grid;gap:14px}.timeline article{display:grid;grid-template-columns:auto 1fr;gap:16px;align-items:start;padding:18px;border:1px solid var(--line);border-radius:28px;background:color-mix(in srgb,var(--surface) 76%,transparent)}.timeline article>span{display:grid;place-items:center;width:48px;height:48px;border-radius:18px;background:linear-gradient(135deg,var(--brand),var(--brand-2));color:#fff;font-weight:950}.timeline h3{margin:0 0 4px}.timeline p{margin:0}.care-panel,.before-after,.final-cta{padding:38px;border:1px solid var(--line);border-radius:42px;background:radial-gradient(circle at 10% 0,color-mix(in srgb,var(--brand) 16%,transparent),transparent 48%),color-mix(in srgb,var(--surface) 78%,transparent);box-shadow:var(--shadow)}.result-frame{position:relative;display:grid;grid-template-columns:1fr 1fr;min-height:320px;overflow:hidden;border:1px solid var(--line);border-radius:38px;background:var(--surface)}.result-frame div{display:grid;place-items:center;font-size:2rem;font-weight:950}.result-frame .before{background:linear-gradient(135deg,var(--surface-muted),var(--surface));color:var(--muted)}.result-frame .after{background:linear-gradient(135deg,color-mix(in srgb,var(--brand) 18%,var(--surface)),color-mix(in srgb,var(--brand-2) 16%,var(--surface)));color:var(--text)}.result-frame span{position:absolute;top:0;bottom:0;left:50%;width:4px;background:#fff;box-shadow:0 0 0 999px rgba(255,255,255,.02);animation:handleMove 3.2s ease-in-out infinite alternate}.related-rail{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(280px,360px);gap:16px;overflow-x:auto;padding-bottom:10px;scroll-snap-type:x mandatory}.related-rail .service-card{scroll-snap-align:start}.final-cta{text-align:center}.final-cta h2{font-size:clamp(2rem,4vw,3.8rem);margin:0 0 12px}@keyframes mediaFloat{to{transform:translateY(-14px) scale(1.01)}}@keyframes handleMove{from{left:42%}to{left:58%}}@media(max-width:900px){.detail-hero,.two-column,.care-panel,.before-after{grid-template-columns:1fr}.detail-hero{min-height:auto;padding-top:112px}.detail-media{order:-1}.detail-media img{height:320px}.three{grid-template-columns:1fr}.intro-panel,.care-panel,.before-after,.final-cta{padding:24px;border-radius:32px}}
  `]
})
