    ...
    <section class="page-section page-hero">
      <div class="section-heading">
        <h1>
          {{
            language() === "fa"
              ? "خدمات زیبایی دندان دکتر سعید مقدم"
              : "Cosmetic dental services by Dr. Saeed Moghaddam"
          }}
        </h1>
        <p>
          {{
            language() === "fa"
              ...
              : "This page presents composite veneers, porcelain veneers and dental bleaching, with indications, steps, aftercare, limits and common questions explained through a health-first approach."
          }}
        </p>
      </div>
    </section>
      ...
      <div class="service-grid">
        ...
        >
          ...
          <span class="icon-bubble"
            ><app-fa-icon [name]="service.icon"></app-fa-icon
          ></span>
          ...
          <a [routerLink]="['/services', service.id]">
            {{
              language() === "fa"
                ? "مشاهده " + pickText(service.title, language())
                : "View " + pickText(service.title, language())
            }}
