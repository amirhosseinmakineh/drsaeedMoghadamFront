  ...
  implements OnInit, OnChanges, OnDestroy
{
  ...
  openCreateDialog(
    type: ReservationType = ReservationType.AfterSalesService,
  ): void {
  ...
  createReservation(): void {
    ...
    const reservationAt = this.combineDateTime(
      this.createDate,
      this.createTime,
    );
    ...
    this.api
      ...
      .subscribe({
        ...
        error: (error) =>
          this.toast.error(this.errorText(error, "ثبت رزرو انجام نشد")),
      });
  }
