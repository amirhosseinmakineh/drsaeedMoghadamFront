...
export interface Service {
  id: string; title: string; subtitle: string; description: string; fullDescription: string;
  image: string; heroImage: string; beforeImage: string; afterImage: string; icon: string; price: string; duration: string;
  features: string[]; steps: TreatmentStep[]; faqs: FaqItem[];
  problems?: string[]; needed?: string[]; suitable?: string[]; notSuitable?: string[]; costFactors?: string[]; aftercare?: string[]; risks?: string[]; relatedIds?: string[];
